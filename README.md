...
|   5 | [MMQ tile/nwarp tuning for gfx1151 (port of PR #21344)](strix-halo/mmq-rdna3_5.md)       | **+27% pp @ d=0, +17% pp @ d=16k** on Qwen 3.6 Q4_K_XL; tg128 flat (last bench 2026-04-19, pre-rebase)                | **Re-ported 2026-05-14** against upstream's new ternary `mmq.cuh` layout (+18/−6 lines, six edits, [doc § Status](strix-halo/mmq-rdna3_5.md#status-2026-05-14--re-ported-against-upstreams-ternary-mmqcuh)). Re-bench against the Qwen 3.6 matrix in [qwen3.6-baseline.md](strix-halo/qwen3.6-baseline.md) pending. |
