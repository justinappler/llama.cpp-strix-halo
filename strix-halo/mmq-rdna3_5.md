...
Upstream [PR #22051](https://github.com/ggml-org/llama.cpp/pull/22051) (JohannesGaessler, merged 2026-04-17) refactored the MMQ host/device helpers we edit in this patch. Per the plan in [upstream.md](upstream.md), the next upstream sync triggers an A/B: confirm the port still wins on the refactored code, or drop it.
