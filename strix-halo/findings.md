...
| 4 | [ROCm config flags: unroll-threshold + `HIPBLASLT_BATCHED=0`](rocm-config.md) | Community reported 2x pp on other models; **null** on Qwen 3.6 | **Bench null, kept on** as AMD-recommended safety nets. Flags live in server-configs, not this repo. |
