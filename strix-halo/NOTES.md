...
Ranked next steps (HIP / Vulkan / dead ends / upstream watch) are maintained in [`backlog.md`](backlog.md). This file keeps the numbered §1–10 code survey above; cross-references such as **#2** in the README tables point back here.
