...
| 2 | ~~**MMQ port-off A/B**~~ **DONE 2026-08-29** - our patches are worth **+27.6% to +29.2% prefill**, decode flat. Remaining sub-item: the `occupancy=4` sweep, which still shipped as a guess. | S | ~~attribution~~ + S | Attribution closed by arms A/C of [fa-mma-d256-26419.md](fa-mma-d256-26419.md#outcome). Upstreaming is now unblocked on the evidence side. |
