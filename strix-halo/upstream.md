...
- **[PR #26171](https://github.com/ggml-org/llama.cpp/pull/26171)** (merged 2026-07-30) - transpose-free gemmv. Decode-side, and the 2026-07-18 profile puts MMVQ at 71-77% of decode time, so this was flagged pre-bench as the one non-MMQ commit in this sync that could move tg. **The re-bench then showed decode up 3-4% at every depth with prefill flat** - the predicted signature. Circumstantial, not proven: no A/B was run against this commit specifically.
