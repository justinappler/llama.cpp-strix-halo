...
| [`mmq-rdna3_5-config-table.md`](mmq-rdna3_5-config-table.md) | RDNA3.5 MMQ config table — re-port onto upstream PR #24127; **kept 2026-07-16**, port's own share unmeasured |
