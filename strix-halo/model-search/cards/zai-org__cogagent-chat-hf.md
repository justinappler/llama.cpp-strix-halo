...
**🔥 News**: The new version `CogAgent-9B-20241220` has been released! Welcome to visit [CogAgent GitHub](https://github.com/THUDM/CogAgent) and [Technical Report](https://cogagent.aminer.cn/blog#/articles/cogagent-9b-20241220-technical-report-en) to explore and use our latest model.

📖 Paper: https://arxiv.org/abs/2312.08914

📄 Technical Report: https://cogagent.aminer.cn/blog#/articles/cogagent-9b-20241220-technical-report-en

🚀 GitHub: https://github.com/THUDM/CogAgent

🤗 Model Page: https://huggingface.co/THUDM/cogagent-9b-20241220

**CogAgent** is an open-source visual language model improved based on **CogVLM**. For more information such as demo, fine-tuning of `THUDM/cogagent-chat-hf`, and query prompts, please refer to [This GitHub](https://github.com/THUDM/CogVLM/)
