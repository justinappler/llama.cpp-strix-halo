...
# Llama-3.3-70B-Instruct EXL3 5.0bpw h6
...
```bash
hf download anthonyw448/Llama-3.3-70B-Instruct-EXL3-5.0bpw-h6 --local-dir ./Llama-3.3-70B-Instruct-EXL3-5.0bpw-h6
```
...
|---|---|---|
| **5.0bpw h6 (this repo)** | **~46 GB — 2x RTX 3090/4090** | **Great balance of size and quality** |
